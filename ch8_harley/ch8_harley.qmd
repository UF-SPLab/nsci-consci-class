...
# Language: Constraints with Composability
...
## Broca & Wernicke's Areas{.smaller}

![](Harley_fig. 8_3.jpg){.absolute top="170" left="0" height="500"}
![](Arcuate_Fasciculus.jpg){.absolute top="170" right="0" height="500"}

- [WP: Arcuate Fasiculus](https://en.wikipedia.org/wiki/Arcuate_fasciculus)  
- [WP: Lateral/Medial Broadmann Areas 40 & 44](https://en.wikipedia.org/wiki/Brodmann_area#Clickable_map:_lateral_surface)
