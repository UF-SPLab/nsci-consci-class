...
The Great Mistake: Confuse immaturity with dysfunction

- Babies cortex begins to form and fold at 6 months in womb
- Babies are largely attracted to language (Language Acquisition Device)

- Dehaene Experiment: 
     - Use fMRI to look inside *2 month old* infants' heads  </br>
		while listening to their maternal language.
...
![](fig34.png){.absolute bottom="-50" right="100" height="400"}
...
- Person who first detects the consciousness in locked-in patients usually not the physician 
...
- EEG of coma patients continue to fluctuate at a slow rate, producing low-frequency waves
- Many cortical and thalamic cells are still alive and active but inappropriate network state.
...
- a series of objective bedside tests that are applied in a precisely controlled manner. Using this scale the medical team can distinguish between a vegetative patient and minimally conscious one with much greater accuracy.
