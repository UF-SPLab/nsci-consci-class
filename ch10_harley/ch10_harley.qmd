...
![](Local-Global-paradigm-Bekinschtein-2009.png){.absolute top="100" left="0" height="350"}
...
![](zpq9990965360001.jpeg){.absolute top="100" left="0" height="500"}

## Local-Global Test{.smaller}

*Block design*: 5 repetitions of 5 tones (50 ms each) with 150 ms inter-stimulus interval (ISI) and 750 - 1000 ms inter-block interval (IBI). 

{{< audio local_global.mp4 controls="yes" width="10%" height="10%" >}}

#### XXXXX Global Regularity Sequence


:::{.columns}
::: {.column width="50%"}

- Global Standard Sequence
<audio controls src="low_five_seq.m4a"> </audio>
...
<audio controls src="low4_hi1.m4a"></audio>
...
#### XXXXY Global Regularity Sequence
...
{{< video "https://youtu.be/2k8fHR9jKVM" width="100%" height="85%" >}}
